...
import EmployeePieChart from "./BloodGroupChart";
import EmployeeBar2dReport_gender from "./GenderChart";
import ExperienceReport from "./ExperienceChart";
    ...
    try {
      const fetchDetails = async () => {
        const { data } = await axios.get(
          "http://localhost:5000/api/employee/getBarChartDetails"
        );
